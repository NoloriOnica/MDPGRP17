...
from tasks.modules.jsonToList import *
from tasks.modules.obsConv import *
...
### Performing these extra step  s in case bluetooth disconnects along the way ###
...
stop_msg = AndroidMessage("","STOP")
androidSend_Queue.put(stop_msg)
